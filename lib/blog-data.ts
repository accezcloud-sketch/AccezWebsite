...
export const blogPosts: BlogPostMeta[] = [
  ...
  {
    slug: 'accez-cloud-vs-saudi-property-management-platforms',
...
- [Accez.Cloud vs Saudi Property Management Platforms](/blog/accez-cloud-vs-saudi-property-management-platforms)
- [The Hidden Costs of Managing Properties Without a System](/blog/hidden-costs-of-managing-properties-without-a-system)
- [How to Scale Your Property Portfolio Successfully](/blog/how-to-scale-your-property-portfolio-without-losing-control)
...
هل أنت مستعد لرؤية كيف تبدو إدارة العقارات الحديثة؟ قم بزيارة [portal.accez.cloud](https://portal.accez.cloud) لمعرفة المزيد.`,
  ...
  'accez-cloud-vs-saudi-property-management-platforms': {
...
### كيف يختلف Accez.Cloud عن Yardi أو Buildium؟

Yardi و Buildium منصات عالمية صُممت أساساً للأسواق الغربية ثم كُيفت لاحقاً للشرق الأوسط. تقدم ميزات محاسبية قوية لكنها تفتقر إلى التكاملات السعودية المحددة (إيجار، سداد/مدى)، وشراكات مقدمي الخدمات المحليين، ونموذج إيرادات السوق. صُمم Accez.Cloud من الألف إلى الياء للسوق السعودي مع دعم ثنائي اللغة عربي-إنجليزي والامتثال المحلي المدمج.

### هل يمكن لـ Accez.Cloud التعامل مع الإيجارات طويلة وقصيرة الأجل؟

نعم. على عكس المنصات المتخصصة في نوع أو آخر (مباعات للقصيرة الأجل، RAY للطويلة الأجل)، يدير Accez.Cloud كلا نوعي الإيجار في نظام واحد. هذا يلغي الحاجة لتشغيل منصات منفصلة للمحافظ المختلطة ويحافظ على جميع بياناتك في مكان واحد.
...
نعم. المنصة مصممة للتوسع من المحافظ الصغيرة إلى العمليات الكبيرة. على عكس المنصات العالمية المؤسسية التي تستبعد الشركات الصغيرة بأسعارها أو تتطلب تدريباً مكثفاً، يقدم Accez.Cloud واجهة بديهية مع تسعير مرن يناسب مديري العقارات بأي حجم.

### هل يتكامل Accez.Cloud مع المنصات الحكومية السعودية مثل إيجار؟

صُمم Accez.Cloud لمتطلبات الامتثال السعودية، بما في ذلك التكامل مع منصة إيجار لتسجيل العقود الإلزامي ودعم معالجة مدفوعات سداد ومدى. تبقى المنصة محدثة مع المعايير التنظيمية السعودية المتطورة حتى لا تضطر لإدارة الامتثال يدوياً.
...
- **المتابعة**: تحقق من رضا المقيم بعد إكمال العمل`,
  ...
  'how-to-create-manage-properties-accez-cloud': {
    content: `Starting with property management in Accez.Cloud is simple and straightforward. Whether you're managing a single property or an entire portfolio, our platform makes it easy to create, publish, and maintain your property listings. In this guide, we'll walk you through every step of the property creation process — from initial setup to ongoing management.

## What You'll Learn

- How to create a new property from scratch
- Adding essential property details and location data
- Uploading property images for better presentation
- Publishing your property to make it live
- Editing and updating property information over time
- Best practices for property setup that saves time later

## Before You Start

Before creating your first property, make sure you have the following ready:

- **An active Accez.Cloud account** with property manager access
- **Property details on hand**: name, address, number of units, and number of floors
- **Property images**: at least 3-5 high-quality photos (exterior, lobby, common areas, amenities). Images should be well-lit, high resolution, and showcase the property's best features. These are the first thing prospective tenants see, so quality matters.
- **Address information**: full street address, city, district, and postal code

Having these ready before you begin means you can complete the entire setup in one session rather than going back and forth.

## Step 1: Navigate to the Properties Page

Begin by logging into your Accez.Cloud property manager portal at [portal.accez.cloud](https://portal.accez.cloud). From your dashboard, navigate to the Properties section using the left sidebar menu.

If you're just getting started, you'll see an empty properties page with a prompt to add your first listing. If you already have properties, they'll appear as cards in a grid view showing key information like name, unit count, and status at a glance.
...
- **Property Name**: Give your property a clear, identifiable name. Use the actual building or compound name that tenants and your team will recognize. Avoid generic names like "Building 1" — instead use "Al Rawdah Tower" or "Jasmine Gardens Compound." This name appears across the entire system, so choose something meaningful.
- **Total Number of Units**: Specify how many units are available in this property. This sets the capacity for your property and helps Accez.Cloud organize your unit management. You can always adjust this later if you add or remove units.
- **Number of Floors**: Enter the total floors in the building. This helps with unit organization and is useful when categorizing units by floor level.

Once you've filled in these essential details, click the "Submit" button to create your property. The system will immediately create the property and redirect you to the property detail page.

## Step 3: Add Property Details and Images

After creation, your property will be in **draft status**. This means it exists in the system but isn't yet active. Click on the property card to access the property details section.

### Upload Property Images

Choose high-quality photos that showcase your property's best features. Recommended images include:

- **Exterior shots**: Front facade, entrance, parking areas
- **Common areas**: Lobby, hallways, elevators
- **Amenities**: Pool, gym, playground, gardens
- **Surrounding area**: Nearby landmarks, street view

**Tip**: Properties with 5 or more images get significantly more engagement from prospective tenants. Avoid blurry, dark, or cluttered photos — they create a negative first impression that's hard to overcome.
...
Accurate address information is essential not just for record-keeping but also for location-based features within Accez.Cloud. Make sure the address matches official records, especially if you need to register leases through the Ejar platform.

### Include Additional Details

Add any other relevant information about the property that helps your team and tenants understand what's available. This could include parking arrangements, security features, nearby schools or shopping centers, or any rules specific to the property.

## Step 4: Publish Your Property

Once you've completed all the necessary information, it's time to make your property live. Click the "Publish Property" button. Your property will now change from draft to **active status**, making it visible throughout your property management system.

You can verify the publication by clicking on the property card and navigating to the property overview section. The status indicator should show "Published" or "Active."

**Important**: Publishing a property doesn't make it publicly visible on the internet. It makes it active within your Accez.Cloud management system so you can start adding units, assigning tenants, and managing operations. Your property data stays private within your organization.

## Step 5: Edit and Update Properties

Properties aren't static — details change over time. Navigate back to your properties list and select the property you want to edit. You can update:

- **Property images**: Add new photos, remove outdated ones, or reorder them
- **Address information**: Correct or update location details
- **Property details**: Modify unit count, floor numbers, or descriptions
- **Availability status**: Mark properties as active, under renovation, or inactive

After making your changes, click the submit button to save your updates. Changes take effect immediately across the system.

### When to Update Your Property

Make it a habit to review property details regularly:

- After completing renovations or adding new amenities
- When address details change (street renaming, postal code updates)
- When adding or removing units from the property
- Seasonally, to ensure images reflect the current state of the property

## Troubleshooting Common Issues

**Property stuck in draft**: Make sure all required fields are completed. The system won't allow publishing if essential information like the property name or unit count is missing.

**Images not uploading**: Check that your images are in a supported format (JPG, PNG) and under the maximum file size. Try compressing large images before uploading.

**Address not saving**: Ensure all address fields are filled in. Some fields that appear optional may be required depending on your region settings.

**Can't find your property**: Use the search bar on the properties page or check your filters. If you have many properties, they may be on a different page or filtered by status.
...
Once your property is created and published, the next steps are:

1. **Add units** to your property — each apartment, villa, or room needs its own unit entry. See our guide on [how to create and manage units in Accez.Cloud](/blog/how-to-create-manage-units-accez-cloud).
2. **Set up work orders** so residents can submit maintenance requests. Learn how in our [work order management tutorial](/blog/how-to-create-manage-work-orders-accez-cloud).
3. **Invite your team** and set up role-based access so staff can help manage the property.

## Key Takeaways

- Properties start in draft status and must be published to go live
- Have your details, images, and address ready before starting to complete setup in one session
- High-quality images with good lighting significantly improve property presentation
- Complete and accurate address information is essential, especially for Ejar compliance
- Properties can be edited and updated at any time — review them regularly
- Publishing makes the property active in your system, not publicly visible on the internet
- The property card provides quick access to all property details and management actions
...
- توفر بطاقة العقار وصولاً سريعاً لجميع تفاصيل العقار`,
  ...
  'how-to-create-manage-units-accez-cloud': {
    content: `Units are the foundation of your property management operations in Accez.Cloud. Every lease, maintenance request, and financial record ties back to a specific unit — so getting your unit setup right from the beginning saves significant time and prevents data issues down the road.
