                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <span className="flex flex-col items-start leading-tight">
                      <span className="text-sm">{(t.contact as Record<string, string>).whatsappCta}</span>
                      <span className="text-xs font-normal opacity-90">{(t.contact as Record<string, string>).whatsappReply}</span>
                    </span>
                  </a>
