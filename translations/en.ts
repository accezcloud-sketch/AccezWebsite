export const en = {
  ...
  pricing: {
    eyebrow: 'Pricing',
    titleLead: 'Simple pricing,',
    titleAccent: 'no surprises',
    newSubtitle: 'Start free, scale as you grow. No credit card required for our Free plan.',
    freeDescription: 'Try the platform with a single property, no risk.',
    basicDescription: 'Perfect for independent landlords getting started.',
    professionalDescription: 'For growing property managers who need the full platform.',
    enterpriseDescription: 'For large portfolios and property management companies.',
    perMonth: '/mo',
    perYear: '/yr',
    ...
    properties6: '10 Properties',
    unitsEach: '(unlimited units)',
    propertyManagement: 'Property Management',
  ...
  contact: {
    ...
    office: 'Office',
    officeDetails: 'Almalqa, Riyadh, Saudi Arabia',
    businessHours: 'Business Hours',
    businessHoursDetails: 'Monday to Friday, 9am to 6pm',
