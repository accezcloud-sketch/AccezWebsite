...
export const metadata: Metadata = {
  title: 'Owner Management & Payouts',
  ...
  alternates: alternatesFor('owners', 'en'),
  openGraph: {
    title: 'Owner Management & Payouts',
    description: 'Give property owners their own portal, a clear ledger and tracked Stripe payouts. Owner statements, balances, invoices and per-owner analytics, part of the all-in-one Accez platform.',
    url: 'https://www.accez.cloud/owners',
    type: 'website',
    images: [{ url: 'https://www.accez.cloud/images/og-image.png', width: 1200, height: 630, alt: 'Owner Management & Payouts | Accez' }],
  },
}
