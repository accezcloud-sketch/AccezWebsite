...
export const metadata: Metadata = {
  title: 'Sales & Developer Projects',
  ...
  alternates: alternatesFor('sales', 'en'),
  openGraph: {
    title: 'Sales & Developer Projects',
    description: 'A sales workspace for developers and agencies, projects, units, a lead-to-close customer pipeline and sales-agent performance, in Arabic and English, on the platform that runs the units after they sell.',
    url: 'https://www.accez.cloud/sales',
    type: 'website',
    images: [{ url: 'https://www.accez.cloud/images/og-image.png', width: 1200, height: 630, alt: 'Sales & Developer Projects | Accez' }],
  },
}
